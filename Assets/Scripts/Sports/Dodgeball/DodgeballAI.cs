    ...
    public class DodgeballAI : MonoBehaviour
    {
        ...
        private AttackType SelectAttack()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    else result = AttackType.RunJump;
                }
            }
        ...
        private void DoMovingAttack(PlayerZoneTracker target)
        {
            if (attackPhase == AttackPhase.Approach)
            {
                ...
                float release = currentAttack == AttackType.RunJump
                    ? runJumpEdgeDistance
        ...
        private void ThrowAtTarget(PlayerZoneTracker target, float charge01 = 1f)
        {
            ...
            // Charge scales power; a rushed counter off a fresh catch (low settle) weakens it.
